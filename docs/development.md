...
Если задача — не экспорт новой модели, а установка опубликованного релиза,
используйте [`jetson-install.md`](jetson-install.md). Там приведены команды
сборки всех четырёх TensorRT engines, CUDA kernels и первого WAV.
