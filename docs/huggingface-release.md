...
- SHA-256 каждого ONNX и исходного checkpoint;
...
4. Подготовка голоса и fixed-prompt cache офлайн.
...
- [ ] чистая установка воспроизведена хотя бы один раз по опубликованной
  инструкции;
- [ ] ONNX checker и TensorRT parser проходят на опубликованных файлах;
- [ ] все ссылки используют release tag или HF revision, а не плавающий `main`;
